...
public class PhotoView extends ImageView {
    ...
    protected void onDetachedFromWindow() {
        ...
        setImageURL(mContext, null, false, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if ((!mIsDrawn) && (mImageURL != null)) {
            ...
            mDownloadThread = PhotoManager.getInstance(mContext).startDownload(this, mCacheFlag);
     ...
     */
    public void setImageURL(Context context, URL pictureURL, boolean cacheFlag, int mEmptyResID) {
    	mContext = context;
        ...
        if (mImageURL != null) {
            ...
            if (!mImageURL.equals(pictureURL)) {
                ...
                PhotoManager.getInstance(mContext).removeDownload(mDownloadThread, mImageURL);
            } else {
       ...
       // setImageDrawable(imageDrawable);
        ...
        if ((mIsDrawn) && (pictureURL != null)) {
             ...
             */
            mDownloadThread = PhotoManager.getInstance(mContext).startDownload(this, cacheFlag);
        }
    }
